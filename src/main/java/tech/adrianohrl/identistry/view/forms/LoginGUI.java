 ...
 */
package tech.adrianohrl.identistry.view.forms;

import javax.swing.JDialog;
import jiconfont.icons.FontAwesome;
import jiconfont.swing.IconFontSwing;
import org.apache.log4j.Logger;
import tech.adrianohrl.identistry.view.Login;
...
public class LoginGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setName("iDentistryLogin"); // NOI18N
        setResizable(false);
        ...
        usernameMessageLabel.getAccessibleContext().setAccessibleName("Username Message");
        ...
        getAccessibleContext().setAccessibleDescription("This is the login screen of the iDentistry Swing Application");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        usernameMessageLabel.setText(" ");
        passwordMessageLabel.setText(" ");
        boolean exists = usernameField.getText().equals("marina");
        if (exists) {
            if (Login.authenticate(usernameField.getText(), passwordField.getPassword())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Logger.getLogger(LoginGUI.class).fatal(ex);
        }
        //</editor-fold>
        //</editor-fold>
